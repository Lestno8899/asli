...
var WebSocketRouter = function WebSocketRouter(connection_query, ctx) {
    var on_connected = arguments.length > 2 && arguments[2] !== undefined ? arguments[2] : function () {};
    ...
    *
    */
    function ConnectionHandler(connection_query, on_message, on_connected) {
        ...
        // Whenever the connecton has ben (re-)stablished, THI on_connected 
    ...
    */
    ConnectionHandler.prototype.reconnect = function () {
        ...
        if (this.connectionsAttemp < 10) {
            ...
            // Waits for 10 seconds to give time to the server to be up and running.
    ...
    *
    */
    function Router(connection_query, ctx, on_connected) {
        ...
        // Of the WebSocket
        this.connection = new ConnectionHandler(connection_query, this.dispatch.bind(this), on_connected);
    }
    ...
    */
    Router.prototype.applyFilters = function (dataFilters, eventFilters) {
        ...
        Object.keys(eventFilters).forEach(function (key) {
            if (!_this2.routify(dataFilters[key].toString()).exec(eventFilters[key].toString())) {
    ...
    */
    ...
    return new Router(connection_query, ctx, on_connected);
};
